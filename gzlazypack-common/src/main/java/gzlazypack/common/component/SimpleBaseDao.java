...
import gzlazypack.common.component.hibernate.HibernateBaseDao;
import gzlazypack.common.page.Pagination;
import gzlazypack.common.util.MyBeanUtils;
 ...
 * @param <QO>
 */
public abstract class SimpleBaseDao<T extends BaseEntity, QO extends BaseQO> extends HibernateBaseDao<T, Serializable> {
	...
	public Integer queryCount(QO qo) {
		...
		int totalCount = ((Number) criteria.setProjection(Projections.countDistinct("id")).uniqueResult()).intValue();
		return totalCount;
	}
