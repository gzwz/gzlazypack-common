...
import gzlazypack.common.component.hibernate.MyResultTransformer;
...
public abstract class BaseDao<T extends BaseEntity, QO extends BaseQO> extends
	...
	public Pagination queryPagination(Pagination pagination) {
		...
		Pagination resultPagination = super.findByCriteria(criteria,
				pagination.getPageNo(), pagination.getPageSize(),
				pagination.isCheckPassLastPageNo(),
				pagination.isSelectTotalCount());
